...
client.on('ready', async () => {
 ...
 client.user.setActivity(`᱗ | A D O N İ S`, { type:'WATCHING' })
...
if (kurulus > 1296000000) kontrol = ' **Güvenli** '
  ...
  const hg = new Discord.MessageEmbed()
    ...
    .setTimestamp()  
 client.channels.cache.get(jkood.Kayıtkanal).send(`${user} <@&${kayıtekibi}>`, hg)
...
client.on("ready", async () => {
  ...
  let botVoiceChannel = client.channels.cache.get("805178973876256828");
